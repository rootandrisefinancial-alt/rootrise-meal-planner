...
// ─── Meal Plan Tab ────────────────────────────────────────────────
function MealPlanTab({ meals, setMeals, preferences, setPreferences }) {
  ...
  return (
    <div>
      ...
      <div style={styles.sectionSub}>Fill in your meals for the week. Plan around what you already have in your kitchen.</div>
...
export default function App() {
  ...
  const screens = [
    ...
    },
    {
      ...
      component: <MealPlanTab meals={meals} setMeals={setMeals} preferences={preferences} setPreferences={setPreferences} />,
    },
    {
      icon: "🛒", label: "Grocery",
